...
import Load from "../components/loads/loads";
...
export default function LoadsPage() {
  ...
  const columns = [
    ...
    { name: "Pickup Time", uid: "pickUpTime", sortable: true },
    { name: "Drop Location", uid: "dropOffLocation", sortable: true },
    { name: "Dropoff Time", uid: "dropOffTime", sortable: true },
    { name: "Rate", uid: "price", sortable: true },
    { name: "Miles", uid: "totalMiles", sortable: true },
    { name: "Weight", uid: "weight", sortable: true },
    { name: "Dropoff Date", uid: "dropOffDate", sortable: true },
    { name: "Rate per mile", uid: "ratePerMile", sortable: true },
      ...
      <section className="bg-white dark:bg-transparent mt-12">
        <div className="py-8 px-4 mx-auto max-w-screen-md text-center lg:py-16 lg:px-12">
          ...
          <p className="font-normal text-black/60 md:text-md xl:text-md dark:text-white/70">
            I&#39;m sorry, but it seems like there is an issue with the server,
            and we are not receiving the necessary information to display the
            details for this page. This could be due to various reasons,
            including a temporary server outage or a misconfiguration.
          </p>
        </div>
      </section>
    );
  ...
  return (
    <div className="mx-12 my-12">
      <Load loads={loads} columns={columns} />
    </div>
  );
}
