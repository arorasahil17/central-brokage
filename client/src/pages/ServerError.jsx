const ServerError = () => {
  return (
    <div className="flex h-[calc(100vh-80px)] items-center justify-center p-5 w-full bg-transparent">
      <div className="text-center">
        ...
        <h1 className="mt-5 text-[36px] font-bold text-red-600  lg:text-[50px]">
          500 - Server error
        </h1>
