...
const Contact = ({ details }) => {
  ...
  useEffect(() => {
    // const startNumber = details.phone.slice(0, 3);
    // const lastNumber = details.phone.slice(3, details.phone.length);
    // setMainNumber(`(${startNumber}${lastNumber})`);
  }, [details.phone]);

  // const mainNumber = `(${startNumber})${lastNumber}`;
  ...
  return (
    <>
      ...
      <section className="bg-white  px-24 lg:py-[120px] overflow-hidden relative z-10 dark:bg-[#09090b] max-sm:px-4">
        <div className="container">
          <div className="flex flex-wrap -mx-4 lg:justify-center">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                <span className="block mb-4 text-base font-semibold text-black/80">
                  Contact Us
                </span>
                <h2 className="mb-2 font-bold uppercase text-gray-800 dark:text-white max-sm:text-[24px] sm:text-[40px] lg:text-[36px] xl:text-[40px]">
            ...
            <div className="w-screen px-4 lg:w-1/2 xl:w-5/12">
              <div className="relative p-8 bg-white rounded-lg shadow-lg sm:p-12 dark:bg-[#0b0b0c]">
                <form>
                  <ContactInputBox
                    type="text"
                    name="name"
                  ...
                  <ContactTextArea
                    ...
                    changeValue={(e) => setMessage(e.target.value)}
                  />
                  <div>
                    <button
                      type="submit"
                      className="w-full p-3 text-white dark:text-black transition border rounded border-primary bg-primary hover:bg-opacity-90"
    ...
    <>
      <div className="mb-6">
        <textarea
          ...
          name={name}
          className=" w-full text-sm px-4 py-3 text-primary/60 bg-transparent dark:text-white/70 dark:placeholder:text-white/60 rounded-lg mt-2 focus:border-neutral-500 dark:focus:border-white/50 focus:outline-none border-1 border-zinc-300 dark:border-neutral-800"
          value={defaultValue}
...
ContactTextArea.propTypes = {
  row: PropTypes.string.isRequired, // Requires rows to be a number
  placeholder: PropTypes.string.isRequired, // Requires placeholder to be a string
  name: PropTypes.string.isRequired, // Requires name to be a string
  defaultValue: PropTypes.string, // defaultValue is optional but should be a string if provided
  changeValue: PropTypes.func.isRequired, // Requires function for handling input changes
};

// Define prop types for the ContactInputBox component
ContactInputBox.propTypes = {
  type: PropTypes.string.isRequired, // Requires type to be a string
  placeholder: PropTypes.string.isRequired, // Requires placeholder to be a string
  name: PropTypes.string.isRequired, // Requires name to be a string
  defaultValue: PropTypes.string.isRequired, // defaultValue is optional but should be a string if provided
  changeValue: PropTypes.func.isRequired, // Requires function for handling input changes
};
